...
const FormTemplate = () => {
    return (
        <>
            <p className='font-medium text-3xl text-secondary leading-10'>Register Account</p>
            <p className='font-normal text-base text-secondary-light-grey leading-6'>Set up your new account. It's as simple as ABC</p>
