...
const FormTemplate = () => {
    return (
        <>
            <p className='font-medium md:text-3xl text-xl text-secondary leading-10'>Login</p>
            <p className='font-normal text-base text-secondary-light-grey leading-6 hidden md:block md:mt-2'>Hello there! welcome back to TaskBolt</p>
