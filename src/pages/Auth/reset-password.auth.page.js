const FormTemplate = () => {
    return (
        <>
            <p className='font-medium text-3xl text-secondary-grey leading-10'>Reset Password</p>
            <p className='font-normal text-base text-secondary-light-grey leading-6 mt-2'>Set a secure password.</p>
